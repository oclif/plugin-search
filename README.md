...
@oclif/plugin-search/1.2.38 linux-x64 node-v20.20.0
...
_See code: [src/commands/search.ts](https://github.com/oclif/plugin-search/blob/1.2.38/src/commands/search.ts)_
