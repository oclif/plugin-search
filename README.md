...
@oclif/plugin-search/1.3.0 linux-x64 node-v22.23.2
...
_See code: [src/commands/search.ts](https://github.com/oclif/plugin-search/blob/1.3.0/src/commands/search.ts)_
<!-- commandsstop -->
