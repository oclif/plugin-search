...
@oclif/plugin-search/2.0.0 linux-x64 node-v22.23.2
...
_See code: [src/commands/search.ts](https://github.com/oclif/plugin-search/blob/2.0.0/src/commands/search.ts)_
<!-- commandsstop -->
