...
@oclif/plugin-search/1.2.45 linux-x64 node-v20.20.2
...
_See code: [src/commands/search.ts](https://github.com/oclif/plugin-search/blob/1.2.45/src/commands/search.ts)_
