...
@oclif/plugin-search/1.2.24 linux-x64 node-v20.19.1
...
_See code: [src/commands/search.ts](https://github.com/oclif/plugin-search/blob/1.2.24/src/commands/search.ts)_
