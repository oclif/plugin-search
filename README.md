...
@oclif/plugin-search/1.2.47 linux-x64 node-v20.20.2
...
_See code: [src/commands/search.ts](https://github.com/oclif/plugin-search/blob/1.2.47/src/commands/search.ts)_
