...
running command...
$ oex (--version)
@oclif/plugin-search/0.0.0 darwin-x64 node-v17.1.0
$ oex --help [COMMAND]
USAGE
  $ oex COMMAND
...
...
_See code: [dist/commands/hello/index.ts](https://github.com/mdonnalley/plugin-search/blob/v0.0.0/dist/commands/hello/index.ts)_
