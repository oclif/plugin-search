...
@oclif/plugin-search/1.2.39 linux-x64 node-v20.20.1
...
_See code: [src/commands/search.ts](https://github.com/oclif/plugin-search/blob/1.2.39/src/commands/search.ts)_
