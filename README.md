...
@oclif/plugin-search/1.2.36 linux-x64 node-v20.19.5
...
_See code: [src/commands/search.ts](https://github.com/oclif/plugin-search/blob/1.2.36/src/commands/search.ts)_
