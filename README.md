...
@oclif/plugin-search/1.1.5-dev.1 linux-x64 node-v18.20.3
...
_See code: [src/commands/search.ts](https://github.com/oclif/plugin-search/blob/1.1.5-dev.1/src/commands/search.ts)_
