...
@oclif/plugin-search/1.2.51 linux-x64 node-v22.22.3
...
_See code: [src/commands/search.ts](https://github.com/oclif/plugin-search/blob/1.2.51/src/commands/search.ts)_
