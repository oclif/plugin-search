...
@oclif/plugin-search/1.0.5 linux-x64 node-v18.18.2
...
_See code: [src/commands/search.ts](https://github.com/oclif/plugin-search/blob/1.0.5/src/commands/search.ts)_
