...
@oclif/plugin-search/1.0.7 linux-x64 node-v18.18.2
...
_See code: [src/commands/search.ts](https://github.com/oclif/plugin-search/blob/1.0.7/src/commands/search.ts)_
