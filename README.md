...
@oclif/plugin-search/1.2.37 linux-x64 node-v20.19.6
...
_See code: [src/commands/search.ts](https://github.com/oclif/plugin-search/blob/1.2.37/src/commands/search.ts)_
