...
@oclif/plugin-search/1.2.52 linux-x64 node-v22.23.0
...
_See code: [src/commands/search.ts](https://github.com/oclif/plugin-search/blob/1.2.52/src/commands/search.ts)_
