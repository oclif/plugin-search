...
@oclif/plugin-search/1.2.28 linux-x64 node-v20.19.4
...
_See code: [src/commands/search.ts](https://github.com/oclif/plugin-search/blob/1.2.28/src/commands/search.ts)_
