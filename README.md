...
@oclif/plugin-search/1.0.19 linux-x64 node-v18.19.1
...
_See code: [src/commands/search.ts](https://github.com/oclif/plugin-search/blob/1.0.19/src/commands/search.ts)_
