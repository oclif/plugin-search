...
@oclif/plugin-search/1.0.10 linux-x64 node-v18.19.0
...
_See code: [src/commands/search.ts](https://github.com/oclif/plugin-search/blob/1.0.10/src/commands/search.ts)_
