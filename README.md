...
@oclif/plugin-search/1.0.21 linux-x64 node-v18.20.1
...
_See code: [src/commands/search.ts](https://github.com/oclif/plugin-search/blob/1.0.21/src/commands/search.ts)_
