...
@oclif/plugin-search/1.2.4 linux-x64 node-v18.20.4
...
_See code: [src/commands/search.ts](https://github.com/oclif/plugin-search/blob/1.2.4/src/commands/search.ts)_
