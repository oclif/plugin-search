...
@oclif/plugin-search/1.2.34 linux-x64 node-v20.19.5
...
_See code: [src/commands/search.ts](https://github.com/oclif/plugin-search/blob/1.2.34/src/commands/search.ts)_
